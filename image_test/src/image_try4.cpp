...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_raw4", 1, &ImageConverter::imageCb, this);
    image_pub_ = it_.advertise("/image_converter/output_video4", 1);
...
class ImageConverter4
{
 ...
 public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_converter/output_video1", 1, &ImageConverter4::imageCb, this);
   // image_pub_ = it_.advertise("/image_converter/output_video1", 1);
