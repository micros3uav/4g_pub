...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_raw3", 1, &ImageConverter::imageCb, this);
    image_pub_ = it_.advertise("/image_converter/output_video3", 1);
...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_converter/output_video1", 1, &ImageConverter2::imageCb, this);
...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_ = it_.subscribe("/image_converter/output_video1", 1, &ImageConverter3::imageCb, this);
   // image_pub_ = it_.advertise("/image_converter/output_video1", 1);
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber sub = n.subscribe("key_command", 1000, KeyboardCallback);
