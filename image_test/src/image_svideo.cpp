...
class ImageConverter
{
  ...
  //cv::VideoWriter writer("VideoTest.avi", CV_FOURCC('D', 'I', 'V', 'X'), 25.0, cv::Size(320, 240));
...
public:
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
   // std::cout<<"11"<<std::endl;
    ...
    cv::imshow("num", num);
    cv::VideoWriter writer("uav_ws\\image1\\VideoTest.avi", CV_FOURCC('D', 'I', 'V', 'X'), 25.0, cv::Size(640, 480));
